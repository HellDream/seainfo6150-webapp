...
const Article = () => {
  ...
  return (
    <div style={style}>
      <h2>
        <b>The Statue of Liberty's torch heads to new museum</b>
      </h2>
      <p>
        <i>
          by Kate Farley (
      ...
      <p>
        Her full name is Liberty Enlightening the World, and she was designed by
        Frederic Auguste Bartholdi and built by Gustave Eiffel -- yes, the same
        guy who built Paris's Eiffel Tower.
      </p>
      <p>
      ...
      <p>
        ...
        superintendent of the Statue of Liberty National Monument. That symbolic
        spirit inspired the decision to inscribe these famous lines on the
        statue's pedestal:
      </p>
      <blockquote>
      ...
      <p>
        ...
        of history, inspiration and deeper analysis of the statue's symbolism
